...
namespace SemiRP.Migrations
{
    ...
    [Migration("20200509213718_Owner")]
    partial class Owner
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SemiRP.Models.Owner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SemiRP.Models.Owner", b =>
                {
                    b.HasOne("SemiRP.Models.Character", "Character")
                        .WithMany()
                        .HasForeignKey("CharacterId");

                    b.HasOne("SemiRP.Models.Group", "Group")
                        .WithMany()
                        .HasForeignKey("GroupId");

                    b.HasOne("SemiRP.Models.VehicleData", null)
                        .WithMany("Borrowers")
            ...
            modelBuilder.Entity("SemiRP.Models.VehicleData", b =>
                {
                    ...
                    b.HasOne("SemiRP.Models.Owner", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId");

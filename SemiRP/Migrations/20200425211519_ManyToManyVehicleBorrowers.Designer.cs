...
namespace SemiRP.Migrations
{
    ...
    [Migration("20200425211519_ManyToManyVehicleBorrowers")]
    partial class ManyToManyVehicleBorrowers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SemiRP.Models.VehicleData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SemiRP.Models.VehicleDataBorrower", b =>
                {
                    ...
                    b.HasKey("BorrowerId", "VehicleId");

                    b.HasIndex("VehicleId");

                    b.ToTable("VehicleDataBorrowers");
                });
            ...
            modelBuilder.Entity("SemiRP.Models.ItemHeritage.Gun", b =>
                {
            ...
            modelBuilder.Entity("SemiRP.Models.Character", b =>
                {
                    ...
                    b.HasOne("SemiRP.Models.Item", "ItemInHand")
                        .WithMany()
                        .HasForeignKey("ItemInHandId");
            ...
            modelBuilder.Entity("SemiRP.Models.VehicleDataBorrower", b =>
                {
                    b.HasOne("SemiRP.Models.Character", "Borrower")
                        .WithMany("BorrowedVehicles")
                        .HasForeignKey("BorrowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SemiRP.Models.VehicleData", "Vehicle")
                        .WithMany("Borrowers")
